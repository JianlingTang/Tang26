...
#PBS -l jobfs=10GB
#PBS -l wd
#PBS -N hybrid_newnn_mid
#PBS -j oe
#PBS -m bea
#PBS -M janet.tang@anu.edu.au
#PBS -o /scratch/jh2/jt4478/output/hybrid_newnn_mid.o
#PBS -e /scratch/jh2/jt4478/output/hybrid_newnn_mid.e
...
LOG_FILE="${LOG_DIR}/hybrid_newnn_mid.log"

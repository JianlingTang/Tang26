...
#PBS -l jobfs=10GB
#PBS -l wd
#PBS -N nn_ngc628_mid_obsbox_r8000
#PBS -j oe
#PBS -m bea
#PBS -M janet.tang@anu.edu.au
#PBS -o /scratch/jh2/jt4478/output/nn_ngc628_mid_pobs_observed_box_restart_8000.o
#PBS -e /scratch/jh2/jt4478/output/nn_ngc628_mid_pobs_observed_box_restart_8000.e

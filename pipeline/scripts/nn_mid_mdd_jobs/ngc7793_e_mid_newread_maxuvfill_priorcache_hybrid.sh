...
#PBS -l jobfs=10GB
#PBS -l wd
#PBS -N nn_ngc7793_e_newread
#PBS -j oe
#PBS -m bea
#PBS -M janet.tang@anu.edu.au
#PBS -o /scratch/jh2/jt4478/output/nn_ngc7793_e_mid_newread_maxuvfill_priorcache_hybrid.o
#PBS -e /scratch/jh2/jt4478/output/nn_ngc7793_e_mid_newread_maxuvfill_priorcache_hybrid.e
...
RESTART="${RESTART:-0}"
OUTNAME="${OUTNAME:-ngc7793-e_mid_newread_maxuvfill_priorcache_tangnn_hybrid.h5}"
...
{
  echo "RUN=ngc7793_e MID new reader no photerr>0.3 cut + max-mag missing UV/U fill + prior-cache weights"

...
#PBS -l jobfs=10GB
#PBS -l wd
#PBS -N nn_ngc628_mdd_hybrid_r8000
#PBS -j oe
#PBS -m bea
#PBS -M janet.tang@anu.edu.au
#PBS -o /scratch/jh2/jt4478/output/nn_ngc628_mdd_pobs_hybrid_mv6_restart_8000.o
#PBS -e /scratch/jh2/jt4478/output/nn_ngc628_mdd_pobs_hybrid_mv6_restart_8000.e

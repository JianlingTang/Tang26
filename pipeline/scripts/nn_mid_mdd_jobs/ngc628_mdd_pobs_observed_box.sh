...
#PBS -l jobfs=10GB
#PBS -l wd
#PBS -N nn_ngc628_mdd_pobs_observed_box
#PBS -j oe
#PBS -m bea
#PBS -M janet.tang@anu.edu.au
#PBS -o /scratch/jh2/jt4478/output/nn_ngc628_mdd_pobs_observed_box.o
#PBS -e /scratch/jh2/jt4478/output/nn_ngc628_mdd_pobs_observed_box.e

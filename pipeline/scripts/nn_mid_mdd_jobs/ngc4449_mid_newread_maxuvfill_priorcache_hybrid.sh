...
#PBS -l jobfs=10GB
#PBS -l wd
#PBS -N nn_ngc4449_newread
#PBS -j oe
#PBS -m bea
#PBS -M janet.tang@anu.edu.au
#PBS -o /scratch/jh2/jt4478/output/nn_ngc4449_mid_newread_maxuvfill_priorcache_hybrid.o
#PBS -e /scratch/jh2/jt4478/output/nn_ngc4449_mid_newread_maxuvfill_priorcache_hybrid.e
...
RESTART="${RESTART:-0}"
OUTNAME="${OUTNAME:-ngc4449_mid_newread_maxuvfill_priorcache_tangnn_hybrid.h5}"
...
{
  echo "RUN=ngc4449 MID new reader no photerr>0.3 cut + max-mag missing UV/U fill + prior-cache weights"

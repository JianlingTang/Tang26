...
#PBS -l jobfs=10GB
#PBS -l wd
#PBS -N nn_ngc5194_ngc5195_mosaic_mdd_newread
#PBS -j oe
#PBS -m bea
#PBS -M janet.tang@anu.edu.au
#PBS -o /scratch/jh2/jt4478/output/nn_ngc5194_ngc5195_mosaic_mdd_newread_maxuvfill_priorcache_hybrid.o
#PBS -e /scratch/jh2/jt4478/output/nn_ngc5194_ngc5195_mosaic_mdd_newread_maxuvfill_priorcache_hybrid.e
...
RESTART="${RESTART:-0}"
OUTNAME="${OUTNAME:-ngc5194-ngc5195-mosaic_mdd_newread_maxuvfill_priorcache_tangnn_hybrid.h5}"
GALAXY_NAMES=(ngc5194-ngc5195-mosaic)
LOG_LABEL="ngc5194_ngc5195_mosaic"
...
LOG_FILE="${LOG_DIR}/${SAFE_OUTNAME}_${LOG_LABEL}_mdd.log"
...
{
  echo "RUN=ngc5194_ngc5195_mosaic MDD new reader no photerr>0.3 cut + max-mag missing UV/U fill + prior-cache weights"

...
#PBS -l jobfs=10GB
#PBS -l wd
#PBS -N nn_ngc5194_mos_mdd
#PBS -j oe
#PBS -m bea
#PBS -M janet.tang@anu.edu.au
#PBS -o /scratch/jh2/jt4478/output/nn_ngc5194_mos_mdd.o
#PBS -e /scratch/jh2/jt4478/output/nn_ngc5194_mos_mdd.e
#PBS -l storage=scratch/jh2+gdata/jh2

GALAXY="ngc5194-ngc5195-mosaic"
MODE="mdd"
OUTNAME="ngc5194-ngc5195-mosaic_mdd.h5"

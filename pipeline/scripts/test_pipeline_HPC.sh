...
#PBS -l jobfs=10GB
#PBS -l wd
#PBS -N hybrid_test_mid
#PBS -j oe
#PBS -m bea
#PBS -M janet.tang@anu.edu.au
#PBS -o /scratch/jh2/jt4478/output/hybrid_test_mid.o
#PBS -e /scratch/jh2/jt4478/output/hybrid_test_mid.e
...
LOG_FILE="${LOG_DIR}/hybrid_test_mid.log"
...
python "${BUNDLE_DIR}/analyze_catalog_mid_mdd.py" \
  ...
  --outname "ngc628_hybridtestmid.h5" \

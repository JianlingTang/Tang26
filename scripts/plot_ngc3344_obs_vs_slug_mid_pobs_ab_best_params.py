...
OUT_PNG = OUTDIR / "ngc3344_observed_vs_slug_predicted_magnitudes_mid_pobs_ab_best_params.png"
OUT_PDF = OUTDIR / "ngc3344_observed_vs_slug_predicted_magnitudes_mid_pobs_ab_best_params.pdf"
OUT_NPZ = OUTDIR / "ngc3344_observed_vs_slug_predicted_magnitudes_mid_pobs_ab_best_params_hist.npz"
OUT_4PANEL_PNG = OUTDIR / "ngc3344_observed_vs_slug_predicted_magnitudes_4scenario_mid_pobs_ab_best_params.png"
OUT_4PANEL_PDF = OUTDIR / "ngc3344_observed_vs_slug_predicted_magnitudes_4scenario_mid_pobs_ab_best_params.pdf"
OUT_4PANEL_NPZ = OUTDIR / "ngc3344_observed_vs_slug_predicted_magnitudes_4scenario_mid_pobs_ab_best_params_hist.npz"
...
SCENARIOS = [
    ("observed-box best + observed-box pobs", PARAMS_OBSERVED_BOX.copy(), "observed-box"),
    ("hybrid mv6 best + hybrid pobs", PARAMS_HYBRID_MV6.copy(), "hybrid"),
    ("NN-only best + NN pobs", PARAMS_NN.copy(), "nn"),
    ("observed-box best + flat pobs", PARAMS_OBSERVED_BOX.copy(), "flat"),
]
